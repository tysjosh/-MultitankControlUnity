...
namespace NWH
{
    ...
    {
        public Grapher g;
        public List<Templer> rawSampleList;
        ...
        {
            sampleNo = 0;
            rawSampleList = new List<Templer>();
        }
        ...
        {
            Templer sample = new Templer(x, t);

            if (rawSampleList == null) rawSampleList = new List<Templer>();
