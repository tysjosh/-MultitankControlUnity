...
public partial class Grapher : EditorWindow
{
    ...
    private static List<Queue<Templer>> replaySampleQueues = new List<Queue<Templer>>();
    ...
    private void ReplayInit()
    {
        ...
        if (replayFiles.Count > 0)
        {
            ...
            {
                List<Templer> gs = FileHandler.LoadSamplesFromCSV(replayFiles[i]);
